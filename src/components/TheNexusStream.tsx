      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                      ...
                      <div className="flex items-center space-x-4 mb-4">
                        <div className={`p-3 rounded-lg bg-gradient-to-br ${panel.color} backdrop-blur-sm border border-white/10 shadow-inner`}>
                          <Icon 
                            ...
                            style={{
                              filter: 'drop-shadow(0 0 8px rgba(255, 255, 255, 0.3)) drop-shadow(0 0 4px rgba(251, 146, 60, 0.4))'
                            }}
                          />
                        </div>
        ...
        <div className="lg:col-span-1 lg:pt-40">
          <div className="mb-6 lg:mt-[64px]">
            ...
            <p className="text-orange-400/70">Live system streams and flow monitoring</p>
          </div>
              ...
              return (
                ...
                >
                  <div className="relative p-5 rounded-xl bg-gradient-to-br from-slate-900/50 via-slate-800/40 to-slate-900/60 backdrop-blur-sm border border-cyan-400/20 hover:border-cyan-400/40 transition-all duration-300 overflow-hidden">
                    {/* Background Glow */}
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-400/5 via-red-400/5 to-orange-400/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                      ...
                      <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <defs>
                          <pattern id={`realtime-${index}`} x="0" y="0" width="30" height="30" patternUnits="userSpaceOnUse">
                            ...
                            <path d="M5,20 Q15,15 25,20" stroke="currentColor" strokeWidth="0.3" fill="none" className="text-red-400" />
                            <circle cx="8" cy="17" r="0.5" fill="currentColor" className="text-orange-400 animate-pulse" />
                            <circle cx="22" cy="17" r="0.4" fill="currentColor" className="text-red-400 animate-pulse" style={{ animationDelay: '0.5s' }} />
                            <rect x="12" y="12" width="6" height="2" rx="1" stroke="currentColor" strokeWidth="0.2" fill="none" className="text-yellow-400" />
                            <line x1="2" y1="25" x2="28" y2="25" stroke="currentColor" strokeWidth="0.2" className="text-orange-400" strokeDasharray="1,1" />
                          </pattern>
                        </defs>
                    ...
                    <div className="relative">
                      <div className="flex items-center space-x-3 mb-3">
                        <div className="p-2 rounded-lg bg-gradient-to-br from-orange-500/20 via-red-400/15 to-orange-500/20 backdrop-blur-sm border border-white/10">
                          <Icon 
                            size={20} 
                      ...
                      <p className="text-orange-400/70 text-sm mb-4 group-hover:text-orange-300/80 transition-colors duration-300">
                        {item.description}
                      </p>
                      ...
                      <div className="h-32 rounded-lg bg-slate-800/20 border border-slate-700/30 flex items-center justify-center">
                        <div className="text-center">
                          <div className="flex space-x-1 mb-2 justify-center">
                            ...
                            <div className="w-2 h-2 bg-orange-400/40 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                            <div className="w-2 h-2 bg-orange-400/40 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                          </div>
                          <span className="text-xs text-orange-400/50 font-mono">MONITORING LIVE STREAMS</span>
                        </div>
                      </div>
                    </div>
                    
                    {/* Activity Indicator */}
                    <div className="absolute bottom-2 right-2 w-2 h-2 bg-orange-400/60 rounded-full animate-pulse"></div>
                  </div>
                </div>
              );
            })}
